            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">    
                    ...
                    <a href="accept_wadir.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm alert_confirm" <?php echo $verif ?>><i class="fas fa-check"></i> Terima</a>
              ...
              <div <?php echo $ketuabaak ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">
                  <a href="accept_wadir.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm alert_confirm" <?php echo $verif2 ?>><i class="fas fa-check"></i> Terima</a>
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-default" <?php echo $verif2 ?>><i class="fas fa-times"></i> Tolak</button>  
                  </div>
                </div>
              </div>
              <!-- END timeline item -->
