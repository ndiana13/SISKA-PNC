	...
	<center>
		...
		<table width="700">
			<tr>
				<td>
				<center>
					<p style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;line-height:107%;font-size:14px;font-family:"Calibri",sans-serif;text-align:center; text-transform: uppercase;'><span style='font-size:19px;line-height:107%;font-family:"Times New Roman",serif;'><?php echo $result['perihal'];?></span></p>
					...
					<p style='margin-top:0cm;margin-right:0cm;margin-bottom:0cm;margin-left:0cm;line-height:107%;font-size:14px;font-family:"Calibri",sans-serif;text-align:center;'><span style='font-size:19px;line-height:107%;font-family:"Times New Roman",serif;'>TAHUN AKADEMIK <?php echo $result['thn_akademik'];?></span></p>
				</center>
				</td>
			</tr>
		</table>
