  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit <?php echo $result['jns_sk'] ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-body">
                  ...
                  <table>
                    <tr>
                      ...
                      <td><center>
                        ...
                        <font size="4" style="text-transform:uppercase; font-family:'Times New Roman',serif;"><strong><?php echo $row['nama_jurusan'];?></strong><br></font>
                ...
                <form action="" method="POST" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <center>
                        <p style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:14px;font-family:"Calibri",sans-serif;text-align:center;'><span style='font-size:19px;line-height:107%;font-family:"Times New Roman",serif;'>TENTANG</p>
                          <input type="text" class="form-control form-control-border" id="perihal_sk" name="perihal_sk" value="<?= html_entity_decode($sk['perihal_sk']);?>"style='margin-top:0cm;margin-right:0cm;margin-bottom:8.0pt;margin-left:0cm;line-height:107%;font-size:19px;font-family:"Times New Roman",serif;text-align:center;'>
                  ...
                  <table>
                    <tr class="text2">
                      <td width="630" style="vertical-align: top; font-family:'Times New Roman',serif;">
                        <textarea id="summernote1" name="menimbang_sk"><?php echo html_entity_decode($sk['menimbang_sk']);?>
                        </textarea>
                      </td>
                    </tr>
                  </table>
                  <table>
                    <tr class="text2">
                      <td width="630" style="vertical-align: top; font-family:'Times New Roman',serif;">
                        <textarea id="summernote2" name="mengingat_sk"><?php echo html_entity_decode($sk['mengingat_sk']);?>
                        </textarea>
                      </td>
                    </tr>
                  </table>
                  <table>
                    <tr class="text2">
                      <td width="630" style="vertical-align: top; font-family:'Times New Roman',serif;">
                        <textarea id="summernote3" name="memperhatikan_sk"><?php echo html_entity_decode($sk['memperhatikan_sk']);?>
                        </textarea>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table>
                    <tr class="text2">
                      <td width="630" style="vertical-align: top; font-family:'Times New Roman',serif;">
                        <textarea id="summernote4" name="menetapkan_sk"><?php echo html_entity_decode($sk['menetapkan_sk']);?>
                        </textarea>
                      </td>
                    </tr>
                  ...
                  <div align="right">
                    <a class="btn btn-secondary" href="detail_pengajuan.php?id_sp=<?=$id_sp;?>">Close</a>
                    <button type="submit" class="btn btn-primary" id="edit" name="edit" >Edit SK</button>
                  </div>
                </form>
              </div>
            </div>
