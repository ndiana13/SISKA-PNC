              ...
              <!-- timeline item -->
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">
                      ...
                      <a href="buat_sk.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm" <?php echo $verif;?>><i class="fas fa-pencil-alt"></i> Buat SK</a>
              ...
              <div <?php echo $baak ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">
                      ...
                      <a class="btn btn-warning btn-sm" href="edit_sk.php?id_sp=<?php echo $detail['id_sp'];?>">Edit SK</a>
                  </div>
                </div>
              </div>
              <!-- END timeline item -->
              ...
              <div <?php echo $ketuabaak ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <br><br>
                    <label>Catatan : </label>
                    <label <?php echo $catatan1?>><?php echo $sk['catatan'] ;?></label> 
                  </div>
                  <div class="timeline-footer">  
                  </div>
                </div>
              ...
              <div <?php echo $wadir ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <br><br>
                    <label>Catatan : </label>
                    <label <?php echo $catatan2; ?>><?php echo $sk['catatan'] ;?></label>
                  </div>
                  <div class="timeline-footer">  
                  </div>
                </div>
              ...
              <div <?php echo $direktur ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <br><br>
                    <label>Catatan :</label>
                    <label <?php echo $catatan3; ?>><?php echo $sk['catatan'] ;?></label> 
                  </div>
                  <div class="timeline-footer">  
                  </div>
                </div>
