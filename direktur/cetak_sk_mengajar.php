	...
	<center>
		...
		<table>
			<tr class="text2">
				...
				<?php 
					}elseif ($result['jns_sp']=='skdoswal'){
				?>
				<td width="450">bahwa dalam rangka melaksanakan Tri Darma Perguruan Tinggi dilingkungan Politeknik Negeri Cilacap, perlu diatur beban tugas dosen/tenaga pengajar dosen wali;</td>
				<?php 
				}else {
				?>
				<td width="450">bahwa dalam rangka melaksanakan Tri Darma Perguruan Tinggi dilingkungan Politeknik Negeri Cilacap, perlu diatur beban tugas magang industri;</td>
				<?php 
				} 
				?>
			</tr>
