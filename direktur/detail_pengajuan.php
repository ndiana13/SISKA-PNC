            ...
            <div class="timeline">
              ...
              <div <?php echo $wadir ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">
                  <a href="accept_direktur.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm alert_confirm" <?php echo $verif2 ?>><i class="fas fa-check"></i> Terima</a>
                    <button type="button" class="btn btn-danger btn-sm alert_decline" data-toggle="modal" data-target="#modal-default" <?php echo $verif2 ?>><i class="fas fa-times"></i> Tolak</button>   
                  </div>
                </div>
              </div>
              <!-- END timeline item -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" class="btn btn-primary" name="submit">Tolak</button>
            </div>
            </form>
          </div>
          <!-- /.modal-content -->
