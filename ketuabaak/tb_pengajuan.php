                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group btn-group-sm">
                          ...
                          <a href="accept_ketuabaak.php?id_sp=<?php echo $d['id_sp']; ?>" class="btn btn-success btn-sm alert_confirm" <?php echo $verif; ?>><i class="fas fa-check"></i> Terima</a>
                          <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-default<?php echo $d['id_sp']; ?>" <?php echo $verif; ?>><i class="fas fa-times"></i> Tolak</button>   
                          <div class="modal fade" id="modal-default<?php echo $d['id_sp']; ?>">
                            <div class="modal-dialog">
                              <div class="modal-content">
                               ...
                               <div class="modal-footer justify-content-between">
                                  ...
                                  <button type="submit" class="btn btn-primary" name="decline">Tolak</button>
                               </div>
                               </form>
                              </div>
                              </div>
