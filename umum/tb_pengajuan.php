              ...
              <?php
                ...
                while($d = mysqli_fetch_array($pengajuan)) {
                  if($d['status_sp']=='1'){
                    ...
                    $tb_sk = mysqli_query($conn,"SELECT * FROM tb_sk");
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group btn-group-sm">
                          ...
                          <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-default<?php echo $d['id_sp']; ?>" <?php echo $verif; ?>><i class="fas fa-pencil-alt"></i> Beri No SK</button>
                                    ...
                                    <div class="row">
                                     <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="no_sk" name="no_sk" placeholder="a/b/c/d">
                                        </div>
                                      </div>
                                      <div class="col-lg-12">
                                        <p>Keterangan<br>
                                        a : Nomor Urut<br>
                                        b : Kode Surat/Keluar/Masuk<br>
                                        c : Kode Klasifikasi Surat<br>
                                        d : Tahun Naskah</p>
                                      </div>
                                   </div>
                               </div>
