              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">    
                    ...
                    <a href="accept_kajur.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm" onclick="return confirm('Anda yakin ingin menerima pengajuan ini ?')" <?php echo $verif ?>><i class="fas fa-check"></i> Accept</a>
                    <a href="decline_kajur.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin ingin menolak pengajuan ini ?')" <?php echo $verif ?>><i class="fas fa-times"></i> Decline</a>
                  </div>
                </div>
              </div>
              <!-- END timeline item -->
              ...
              <div <?php echo $ketuabaak ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <br><br>
                    <label <?php echo $catatan1 ?>>Catatan : <?php echo $sk['catatan'] ;?></label> 
                  </div>
                  <div class="timeline-footer">
                  <a href="accept_wadir.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm alert_confirm" <?php echo $verif2 ?>><i class="fas fa-check"></i> Accept</a>
              ...
              <div <?php echo $wadir ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <br><br>
                    <label <?php echo $catatan2 ?>>Catatan : <?php echo $sk['catatan'] ;?></label> 
                  </div>
                  <div class="timeline-footer">  
                  </div>
                </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Decline SK</h4>
