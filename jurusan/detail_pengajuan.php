            ...
            <div class="timeline">
              ...
              <div>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">
                    <a class="btn btn-success btn-sm" href="cetak_sp.php?id_sp=<?php echo $detail['id_sp'];?>">Cetak SP</a>
                  </div>
                </div>
              </div>
              <!-- END timeline item -->
              ...
              <div <?php echo $wadir ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-footer">
                  <a href="accept_direktur.php?id_sp=<?php echo $detail['id_sp']; ?>" class="btn btn-success btn-sm" onclick="return confirm('Anda yakin ingin menerima pengajuan ini ?')" <?php echo $verif2 ?>><i class="fas fa-check"></i> Accept</a>
              ...
              <div <?php echo $direktur ?>>
                ...
                <div class="timeline-item">
                  ...
                  <div class="timeline-body">
                    ...
                    <br><br>
                    <label <?php echo $catatan3 ;?>>Catatan : <?php echo $sk['catatan'] ;?></label> 
                  </div>
                  <div class="timeline-footer">  
                  </div>
                </div>
