	...
	<center>
		<table width="700">
			<tr>
                ...
                <td>
                <center>
                  <font size="5" style="font-family:'Times New Roman',serif;">KEMENTRIAN PENDIDIKAN, KEBUDAYAAN, <br>RISET DAN TEKNOLOGI<br></font>
            ...
            <tr class="text2">
              ...
              <td width="90"style="font-family:'Times New Roman',serif;"><br><br> Ditetapkan di Cilacap<br>DIREKTUR POLITEKNIK NEGERI CILACAP</td>
           	...
           	<tr class="text2">
              	...
              	$row_dir    = mysqli_fetch_array($sql);
              	if ($result['status_sp'] == '9') {
                	echo "<img src='../dist/img/".$row_dir['ttd']."' width='160' height='90'>";
