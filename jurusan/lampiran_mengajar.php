    ...
    <section class="content">
      <div class="container-fluid">
                      ...
                      <div class="row">
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <small style="color:#dc3545;">*Format file yang diperbolehkan adalah file berformat *.xlsx max 50MB!</small>
                          </div>
                        </div>
                      </div>
                  </div>
        ...
        <!-- /. Modal Import Lampiran -->       
              ...
              <tbody>
              <?php                
                $result = mysqli_query($conn, "SELECT * FROM tb_lam_mengajar WHERE id_sp ='$id_sp'");
                $no= 1;
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <div class="btn-group btn-group-sm">
                          <a data-toggle="modal" data-target="#modal-lg<?php echo $d['id_lam_mengajar']; ?>" class="btn btn-info"><i class="fas fa-pencil-alt"></i> Edit</a>
                          <a href="hapus_lam_doswal.php?id_lam_doswal=<?php echo $d['id_lam_mengajar']; ?>" class="btn btn-danger alert_konfirmasi"><i class="fas fa-trash"></i> Hapus</a>       
                        </div>
                      </td>
                      <!-- /.timeline -->
                      <!-- Modal Import Lampiran -->
...
if (isset($_POST['upload'])) {
    ...
    foreach ($Reader as $Key => $Row)
    {
     ...
     if ($Key< 1) continue;     
      $query=mysqli_query($conn, "INSERT INTO tb_lam_mengajar(id_lam_mengajar,nm_dosen,nidn,nip_dis,matkul1,matkul2,matkul3,matkul4,matkul5,matkul6,matkul7,matkul8,matkul9,matkul10,prodi1,prodi2,prodi3,prodi4,prodi5,prodi6,prodi7,prodi8,prodi9,prodi10,kelas1,kelas2,kelas3,kelas4,kelas5 ,kelas6 ,kelas7 ,kelas8 ,kelas9 ,kelas10,sks_matkul1,sks_matkul2,sks_matkul3,sks_matkul4,sks_matkul5,sks_matkul6,sks_matkul7,sks_matkul8,sks_matkul9,sks_matkul10 ,sks1 ,sks2 ,sks3 ,sks4  sks5 ,sks6 ,sks7 ,sks8 ,sks9 ,sks10,id_sp) VALUES ('','".$Row[0]."','".$Row[1]."','".$Row[2]."','".$Row[3]."','".$Row[4]."','".$Row[5]."','".$Row[6]."','".$Row[7]."','".$Row[8]."','".$Row[9]."','".$Row[10]."','".$Row[11]."','".$Row[12]."','".$Row[13]."','".$Row[14]."','".$Row[15]."','".$Row[16]."','".$Row[17]."','".$Row[18]."','".$Row[19]."','".$Row[20]."','".$Row[21]."','".$Row[22]."','".$Row[23]."','".$Row[24]."','".$Row[25]."','".$Row[27]."','".$Row[28]."','".$Row[29]."','".$Row[30]."','".$Row[31]."','".$Row[32]."','".$Row[34]."','".$Row[35]."','".$Row[36]."','".$Row[37]."','".$Row[38]."','".$Row[39]."','".$Row[40]."','".$Row[41]."','".$Row[42]."','".$Row[43]."','".$Row[44]."','".$Row[45]."','".$Row[46]."','".$Row[47]."','".$Row[48]."','".$Row[49]."','".$Row[50]."','".$Row[51]."','".$Row[52]."','$id_sp')");
    }
    if ($query) {
      $_SESSION['alert_import'] = 'true';
      echo 
      "<script>
      document.location.href='lampiran_mengajar.php?id_sp=$id_sp';
      </script>";
      }else{
        echo mysqli_error();
      }
