...
function acc_kajur($id_sp) {
	...
	$query ="UPDATE tb_sp SET status_sp = '1', tgl_kajur = '$tgl' WHERE id_sp = $id_sp";
...
function dec_kajur($id_sp) {
	...
	$query ="UPDATE tb_sp SET status_sp = '10', tgl_kajur = '$tgl' WHERE id_sp = $id_sp";
...
$row_sk_mengajar = mysqli_query($conn,"SELECT * FROM tb_sp INNER JOIN tb_jns_sk ON tb_sp.id_jns_sk = tb_jns_sk.id_jns_sk WHERE tb_sp.id_jns_sk = 2 AND status_sp = 0");
...
$row_sk_magang = mysqli_query($conn, "SELECT * FROM tb_sp INNER JOIN tb_jns_sk ON tb_sp.id_jns_sk = tb_jns_sk.id_jns_sk WHERE tb_sp.id_jns_sk = 3  AND status_sp = 0");
...
$row_sk_doswal = mysqli_query($conn,"SELECT * FROM tb_sp INNER JOIN tb_jns_sk ON tb_sp.id_jns_sk = tb_jns_sk.id_jns_sk WHERE tb_sp.id_jns_sk = 1 AND status_sp = 0");
