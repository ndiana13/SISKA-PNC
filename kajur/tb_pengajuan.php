                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="btn-group btn-group-sm">
                          ...
                          <a href="accept_kajur.php?id_sp=<?php echo $d['id_sp']; ?>" class="btn btn-success btn-sm alert_confirm" <?php echo $verif; ?>><i class="fas fa-check"></i> Terima</a>
                          <a href="decline_kajur.php?id_sp=<?php echo $d['id_sp']; ?>" class="btn btn-danger btn-sm alert_decline" <?php echo $verif; ?>><i class="fas fa-times"></i> Tolak</a>     
                        </div>
